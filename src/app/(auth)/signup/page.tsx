...
import { Mail, Lock, User, UserPlus, Eye, EyeOff, AlertTriangle } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const { user, isLoading: authLoading, signUp, signInWithGoogle, authError, clearError } = useAuth();
      ...
      >
        <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-[16px] p-6 md:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.25)]">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Join {APP_NAME}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={cn(
                    'w-full bg-[var(--glass-surface)] border rounded-[12px]',
                    'pl-10 pr-10 py-3 text-sm text-[var(--text-primary)] placeholder-[#6B7280]',
                    'outline-none transition-all duration-[250ms] ease',
                    confirmPassword.length > 0 && !passwordsMatch
                      ? 'border-[#EF4444]/40 focus:border-[#EF4444]/60'
                      : 'border-[var(--glass-border)] focus:border-[#3B82F6] focus:shadow-[0_0_0_4px_rgba(59,130,246,0.15)]'
                  )}
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              className={cn(
                'w-full py-3 px-6 rounded-[12px] font-semibold text-sm',
              ...
              whileHover={!isLoading && formValid ? { y: -1 } : {}}
              whileTap={!isLoading && formValid ? { y: 0 } : {}}
            >
              {isLoading ? (
                <motion.div
