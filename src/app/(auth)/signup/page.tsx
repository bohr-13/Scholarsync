...
import { Mail, Lock, User, UserPlus, Eye, EyeOff, Sparkles, AlertTriangle } from 'lucide-react';
      ...
      >
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-8 shadow-2xl shadow-black/20">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-slate-100 mb-1">Join {APP_NAME}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    confirmPassword.length > 0 && !passwordsMatch
                      ...
                      : 'border-white/[0.08] focus:border-blue-500/30 focus:shadow-[0_0_20px_-5px_rgba(59,130,246,0.15)]'
                  )}
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              whileHover={!isLoading && formValid ? { scale: 1.01 } : {}}
              whileTap={!isLoading && formValid ? { scale: 0.99 } : {}}
            >
              {isLoading ? (
                <motion.div
