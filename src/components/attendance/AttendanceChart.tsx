...
function CustomTooltip({ active, payload }: CustomTooltipProps) {
  ...
  return (
    <div className="rounded-xl border border-white/[0.08] bg-slate-900/95 backdrop-blur-xl p-3 shadow-xl">
      <p className="text-sm font-semibold text-slate-100 mb-1">{data.name}</p>
      <p className="text-xs text-slate-400 mb-2">{data.code}</p>
