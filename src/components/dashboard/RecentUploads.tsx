...
export default function RecentUploads() {
  ...
  return (
    <TiltCard className="p-6 h-full flex flex-col justify-between" intensity={3}>
      <div>
        ...
        {isLoading ? (
          ...
          <div className="py-8 text-center">
            <p className="text-xs text-slate-400 dark:text-slate-500">No scanned notices yet. Try scanning one! 📄</p>
          </div>
        ) : (
          <div className="space-y-3.5">
            {recentNotices.map((notice, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl border border-white/[0.04] dark:bg-white/[0.01] bg-slate-50 hover:bg-white/[0.03] transition-colors"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-1 text-[9px] dark:text-slate-500 text-slate-400">
      ...
      <div className="pt-4 mt-4 border-t border-slate-200/60 dark:border-white/[0.05] flex justify-between items-center text-xs">
        <span className="flex items-center gap-1 text-[10px] dark:text-emerald-400 text-emerald-600 font-semibold font-mono">
