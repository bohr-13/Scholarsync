  ...
  return (
    <section className="relative py-24 px-4 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <motion.div
          className="rounded-[24px] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-8 md:p-16 glow-blue relative overflow-hidden flex flex-col items-center"
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-[var(--text-primary)] mb-6 max-w-2xl">
            Start organizing your <br className="hidden sm:inline" />
            academic life today.
          </h2>
          <p className="text-base sm:text-lg text-[var(--text-secondary)] max-w-lg mb-10 leading-relaxed">
            Join thousands of students who stopped drowning in WhatsApp spam and messy PDFs. Get your personal academic assistant.
          </p>

          <Link
            href="/login"
            className="flex items-center gap-2.5 px-8 py-4 rounded-xl text-white font-semibold bg-[#3B82F6] hover:bg-[#2563EB] shadow-lg transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
          >
