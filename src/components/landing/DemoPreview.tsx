  ...
  return (
    <div className="text-center max-w-2xl mx-auto mb-16">
      ...
      <p className="text-slate-500 dark:text-slate-400">
        Take a glance at how your new workspace aggregates notice details,
        urgency, tasks, and attendance levels with absolute visual elegance.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="flex justify-between items-center pb-4 border-b border-white/[0.06] mb-6">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs dark:text-slate-500 text-slate-400 font-mono ml-3">
          scholarsync.os/demo-preview
        </span>
      </div>
...
function UrgentNotificationCard() {
  return (
    <div className="p-5 rounded-2xl border border-rose-500/20 bg-rose-500/[0.03] glow-rose">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold dark:text-rose-400 text-rose-600">
            Urgent Deadline Action Needed
          </h3>
        </div>
      ...
      <h4 className="text-base font-bold dark:text-slate-100 text-slate-800 mb-1">
        Semester IA-2 Internal Assessment Form Submission
      </h4>
      <p className="text-xs dark:text-slate-400 text-slate-600 mb-4 leading-relaxed">
        Fill and submit the handwritten IA-2 assessment form with signatures
        from subject heads to room 203. No email registrations accepted.
      </p>
  ...
  return (
    <div className="p-5 rounded-2xl border border-white/[0.06] dark:bg-white/[0.01] bg-slate-50">
      <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">
        Priority Sorting Agenda
      </h3>
      <div className="space-y-3">
        {[
          {
            title: "Upload Internship Completion Slip",
            category: "placement",
            priority: "high",
            date: "Due in 5 days",
          },
          {
            title: "Return library books: Clean Architecture",
            category: "admin",
            priority: "medium",
            date: "Due in 2 days",
          },
...
function AIPriorityInsights() {
  return (
    <TiltCard className="p-5" intensity={4}>
      <div className="flex items-center gap-2 mb-3">
        <Sparkles className="w-4 h-4 text-blue-400" />
        <h3 className="text-xs font-bold uppercase tracking-wider dark:text-slate-300 text-slate-500">
          AI Priority Insights
        </h3>
      </div>
      <div className="space-y-4">
        <div className="p-3.5 rounded-xl bg-indigo-500/[0.04] border border-indigo-500/10">
          <p className="text-xs font-bold dark:text-indigo-400 text-indigo-600 mb-1">
            Emergency Warning active
          </p>
          <p className="text-[11px] dark:text-slate-400 text-slate-600 leading-relaxed">
            Operating Systems (CS-303) attendance is at 70.6% (critical limit is
            75%). Bunking next class is NOT recommended.
          </p>
        </div>
        <div className="p-3.5 rounded-xl bg-emerald-500/[0.04] border border-emerald-500/10">
          <p className="text-xs font-bold dark:text-emerald-400 text-emerald-600 mb-1">
            Scholarship opportunity
          </p>
          <p className="text-[11px] dark:text-slate-400 text-slate-600 leading-relaxed">
            Matches AICTE Pragati scholarship parameters perfectly. You qualify
            for ₹50,000/year reward.
          </p>
        </div>
      </div>
    </TiltCard>
...
function OverwhelmedVisualizer() {
  return (
    <div className="p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/[0.03] text-center">
      ...
      <h4 className="text-xs font-bold dark:text-indigo-300 text-indigo-600 mb-1">
        Experiencing stress?
      </h4>
      <p className="text-[10px] dark:text-slate-400 text-slate-600 mb-3">
        Activate &quot;I&apos;m overwhelmed&quot; Focus Mode in one click to
