          ...
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative w-16 h-16 rounded-2xl bg-white/[0.03] border border-white/[0.08] dark:bg-slate-900 dark:border-white/[0.08] flex items-center justify-center mb-6 shadow-xl relative group">
                  ...
                  <Icon className="w-6 h-6 dark:text-blue-400 text-blue-600 relative z-10" />
                  <span className="absolute -top-3.5 -right-3.5 w-7 h-7 rounded-full bg-slate-800 border border-white/[0.06] flex items-center justify-center text-xs font-mono font-bold dark:text-slate-400 text-slate-500">
                    {step.number}
                  </span>
                </div>

                <h3 className="text-lg font-bold mb-3 dark:text-slate-100 text-slate-800">
                  {step.title}
                </h3>
