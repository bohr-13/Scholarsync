...
export default function ProblemStatement() {
  return (
    <section className="relative py-24 border-t border-[var(--glass-border)] px-4">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs font-semibold uppercase tracking-widest text-rose-500 bg-rose-500/10 px-3 py-1 rounded-full">
            The Student Chaos
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
          {problems.map((prob, i) => {
            ...
            return (
              ...
              >
                <TiltCard className="p-6 h-full flex gap-4 hover:shadow-rose-500/5 hover:border-[var(--error)]/20" glowColor="rgba(239,68,68,0.05)" intensity={4}>
                  ...
                  <div>
                    <span className="text-[10px] font-mono font-semibold text-[var(--error)] bg-[var(--error)]/5 px-2 py-0.5 rounded border border-[var(--error)]/10">
                      {prob.tag}
                    </span>
                    <h3 className="text-lg font-bold mt-2.5 mb-1.5 text-[var(--text-primary)]">
                      {prob.title}
                    </h3>
        ...
        <motion.div
          className="rounded-[16px] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-8 md:p-12 relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-xl">
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-[var(--text-primary)] mt-4 mb-4">
            ...
            <div className="flex items-center justify-center shrink-0">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#3B82F6] to-[#2563EB] flex items-center justify-center shadow-xl">
