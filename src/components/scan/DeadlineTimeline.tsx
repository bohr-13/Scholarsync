    ...
    >
      ...
      {deadline && (
        <motion.div variants={nodeVariants} className="relative flex items-start gap-4 pb-6">
          ...
          <div
            className={cn(
              'flex-1 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-sm p-4',
              'shadow-lg'
            )}
          >
            ...
            <div className="flex items-center gap-1.5 mt-1.5">
              ...
              <p className="text-xs text-[var(--text-secondary)]">{deadlineLabel}</p>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {taskCards.map((task, i) => {
        ...
        return (
          ...
          >
            ...
            <motion.div
              className={cn(
                'flex-1 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-surface)] backdrop-blur-sm p-4',
            ...
            >
              ...
              <p className="text-sm font-medium text-[var(--text-primary)] mb-1">{task.title}</p>
              ...
              {task.dueDate && (
                <div className="flex items-center gap-1.5">
                  <Clock className="w-3 h-3 text-[var(--text-secondary)]/60" />
