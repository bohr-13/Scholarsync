...
export default function ScholarshipCard({
  ...
  const urgencyConfig = {
    critical: { color: 'text-rose-400', bg: 'bg-rose-500/10 border-rose-500/20 shadow-[0_0_15px_rgba(244,63,94,0.1)]' },
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <TiltCard className="p-5 h-full flex flex-col justify-between border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl hover:bg-white/[0.04] transition-all duration-300 relative group overflow-hidden" intensity={4}>
        ...
        <div>
          ...
          {scholarship.description && (
            <p className="text-xs text-slate-400 leading-relaxed mb-4 line-clamp-3 relative z-10">
              {scholarship.description}
            </p>
          )}
